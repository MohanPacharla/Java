...
<body>
	...
	<h1>Welcome <%=session.getAttribute("user_name")%></h1>
		...
		<input type=text name="artist_id" class="hai" id="hai1" value="" placeholder="artistid"><br>
		<span id="bye1" style=color:red></span><br>
		<input type=text name="artist_name" class="hai" id="hai2" value="" placeholder="artistname"><br> 
		<span id="bye2" style=color:red></span><br>
		<input type=text name="profession" class="hai" id="hai3" value="" placeholder="profession"><br>
