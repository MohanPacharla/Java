...
<body>
	...
	<h1>Welcome <%=session.getAttribute("user_name")%></h1>
		...
		<input type="hidden" name="action4" value="Add4"> 
		<input type=text name="genre_id" class="hai" id="hai1" value="" placeholder="genreid"><br>
		<span id="bye1" style=color:red></span><br>
		<input type=text name="genre_name" class="hai" id="hai2" value="" placeholder="genrename"><br>
		<span id="bye2" style=color:red></span><br>
	    <input type=submit value="submit"><br><br><a href="AdminAlbumApplication.jsp">BACK</a>
	</form>
</body>
</html>
